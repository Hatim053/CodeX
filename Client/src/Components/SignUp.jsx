...
function SignUp() {
    ...
    return (
        <>
         <div className="w-screen h-screen bg-cover bg-center bg-no-repeat pt-16 pl-[40vw]" style={{ backgroundImage: `url(${'example'})` }} >
                 <div className="w-full max-w-sm p-6 ml-auto mr-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form className="mt-6">
                  <div >
                    ...
                    <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-950 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-900 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Enter You Name" />
                </div>
                <div className="mt-2" >
                    <label for="username" class="block text-sm text-gray-800 dark:text-gray-200">Username</label>
                    <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-900 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"  placeholder="Enter Your Email"/>
                </div>
        
                <div className="mt-2">
                    <div className="flex items-center justify-between">
                        <label for="password" class="block text-sm text-gray-800 dark:text-gray-900">Password</label>
